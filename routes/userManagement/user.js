...
router.post('/addUser', (req, res) => {
    ...
    let sql_adUser = "insert into " + propObj.svayamSystemDbName + ".user_info (email,password,b_acct_id) values "
        + " (" + SqlString.escape(email) + "," + SqlString.escape(enc_passwd) + "," + SqlString.escape(b_acct_id) + ")"
...
router.get('/getUsersInfo:dtls', (req, res) => {
    ...
    let sql_getUser = "Select ui.user_id,email,signup_time,is_admin,first_name,last_name,designation,group_concat(ux.prod_cd) as prod_cd from  (Select user_id,email,signup_time,is_admin,first_name,last_name,designation from " + propObj.svayamSystemDbName + ".user_info where"
        + " b_acct_id=" + SqlString.escape(b_acct_id) + " and user_id !=" + admin_uid + ") ui join " + propObj.svayamSystemDbName + ".user_xref_products ux on "
        + " ui.user_id=ux.user_id group by ui.user_id,email,signup_time,is_admin,first_name,last_name,designation"
